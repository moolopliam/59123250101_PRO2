...
(function($) {
    ...
    $.fn.seatCharts = function(setup) {
                                ...
                                return function(e) {
                                    ...
                                    case 38:
                                        ...
                                        $newSeat = (function findAvailable($rows, $seats, $currentRow) {
                                            ...
                                            $newSeat = $newRow.find(".seatCharts-seat,.seatCharts-space")
                                                .eq($seats.index($seat));
        ...
        settings.naming.rows = settings.naming.rows ||
        (function(length) {
            var rows = [];
        ...
        settings.naming.columns = settings.naming.columns ||
        (function(length) {
            var columns = [];
            for (var i = 1; i <= length; i++) {
                columns.push(i);
        ...
        $.each(settings.map,
            function(row, characters) {
                ...
                $.each(characters.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi),
                        ...
                        $row.append(character != "_"
                            ...
                            (function(naming) {
                                ...
                                settings.seats[character] =
                                    character in settings.seats ? settings.seats[character] : {};

                                var id = overrideId
                                    ? overrideId
                                    : naming.getId(character, naming.rows[row], naming.columns[column]);
                                seats[id] = new seat({
                                    id: id,
                                    label: overrideLabel
                                        ? overrideLabel
                                        : naming.getLabel(character, naming.rows[row], naming.columns[column]),
                                    row: row,
                                    column: column,
                                    character: character
                                });
                        ...
                        $ul.append(
                            ...
                            .append(
                                ...
                                .addClass(["seatCharts-seat", "seatCharts-cell", item[1]].concat(
                                        ...
                                        ? []
                                        : settings.seats[item[0]].classes).join(" ")
                                )
                            )
                            .append(
                                $("<span></span>")
