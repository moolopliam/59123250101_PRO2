...
(function($) {
    $.fn.selectstyle = function(option) {
        ...
        this.each(function() {
            ...
            html =
                '<div class="selectstyle ss_dib ' +
                setting.theme +
                '" style="width:' +
                parseInt(setting.width) +
                'px;">' +
                '<div id="select_style" class="ss_button" style="width:' +
                parseInt(setting.width) +
                "px;" +
                style +
                '">' +
                '<div class="ss_dib ss_text" id="select_style_text" style="margin-right:15px;width:' +
                (parseInt(setting.width) - 20) +
                ...
                "</div>";
            if (search == "true") {
                html += '<ul id="select_style_ul" sid="' +
                    id +
                    '" class="ss_ulsearch" style="max-height:' +
                    setting.height +
                    "px;width:" +
                    (parseInt(setting.width) + 20) +
                    'px;"><div class="search" id="ss_search"><input type="text" placeholder="Search"></div><ul style="max-height:' +
                    (parseInt(setting.height) - 53) +
                    "px;width:" +
                    (parseInt(setting.width) + 20) +
                    'px;" class="ss_ul">' +
                    html_op +
        ...
        $("body").delegate("div#ss_search input",
            "keyup",
            function(e) {
        ...
        $("body").delegate("div#select_style",
            "click",
            function(e) {
        ...
        $("body").delegate("ul#select_style_ul li",
            "click",
            function(e) {
                ...
                $("#" + sid).children("option").filter(function() { return $(this).val() == vl }).prop("selected", true)
                    .change();
            });
        $(document).delegate("body",
            "click",
            function(e) {
